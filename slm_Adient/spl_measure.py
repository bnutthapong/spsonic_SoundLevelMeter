...
class sound_measure():
    ...
    def stream_readchunk(self):
        ...
        try:
            ...
            y = lfilter(NUMERATOR, DENOMINATOR, self.data)
            self.SPL_A = 20*np.log10(spl.rms_flat(y))
            #self.chunksRead += 1
...
if __name__ == "__main__":
    ear = sound_measure(rate=96000, updatesPerSecond=10)  # optinoally set sample rate here
